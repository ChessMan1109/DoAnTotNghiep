<footer>
        ...
        <div class="f-c-main">
            ...
            <div class="f-c-main-right">
                <div class="f-c-main-right-column">
                    ...
                    <li><a href="category_details.php?categories=26">Điện thoại Samsung</a></li>
                    <li><a href="category_details.php?categories=29">Điện thoại Oppo</a></li>
                    <li><a href="category_details.php?categories=30">Điện thoại Nokia</a></li>
                </div>
                <div class="f-c-main-right-column">
                    <h3>Tất cả trang</h3>
    ...
    <div class="footer-container-bottom">
        <div class="f-c-bottom">
            <h3><i class="fa-regular fa-copyright"></i>Bản quyền thuộc về <span>GoodPhone</span></h3>
