    ...
    <section id="section-quanlysanpham">
        <div class="add-product-container1">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                $query = "UPDATE phones SET Name = '$name', Color = '$color', Description = '$description', Price = '$price' WHERE ID = '$product_id'";
                $result = mysqli_query($conn, $query);

                if ($result) {
                    // Xóa các hình ảnh cũ của sách
                    $query_delete_images = "DELETE FROM phones_images WHERE PhoneID = '$product_id'";
                    ...
                    foreach ($images['tmp_name'] as $key => $tmp_name) {
                        ...
                        $query_insert_image = "INSERT INTO phones_images (PhoneID, ImageURL) VALUES ('$product_id', '$image_path')";
