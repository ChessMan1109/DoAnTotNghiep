<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "UPDATE phones SET Discount = $discount WHERE ID = $phone_id";
...
<!-- HTML -->
<td class='discount-td' data-phone-id='<?php echo $row["ID"]; ?>'>
    <?php
    ...
    <form action='update_discount.php' method='POST'>
        <input type='hidden' name='phone_id' value='<?php echo $row["ID"]; ?>'>
